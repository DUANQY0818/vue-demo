...
const Default = {
  template: ` <div class="defautl">default</div>`,
};
...
const Qux = {
  template: `
    <div class="qux">
      ...
      <router-view class="qux-child"></router-view>
    </div>
  `,
};
...
const Quux = {
  template: `
    <div>
      quux
      <router-link :to="{ name: 'quuy' }">go to quuy</router-link>
    </div>
  `,
};
